...
function initializeConstants() {
  ...
  [
    ...
    Module["ExpressionIds"][name] = Module[name + "Id"] =
      Module["_Binaryen" + name + "Id"]();
  });

  // External kinds
  Module["ExternalKinds"] = {};
  ["Function", "Table", "Memory", "Global", "Tag"].forEach((name) => {
    Module["ExternalKinds"][name] = Module["External" + name] =
...
function wrapModule(module, self = {}) {
  ...
  self["loop"] = function (label, body) {
    return preserveStack(() =>
      Module["_BinaryenLoop"](module, strToStack(label), body),
    );
  };
  self["break"] = self["br"] = function (label, condition, value) {
    return preserveStack(() =>
      Module["_BinaryenBreak"](module, strToStack(label), condition, value),
    );
  };
  ...
  self["switch"] = function (names, defaultName, condition, value) {
    return preserveStack(() =>
      Module["_BinaryenSwitch"](
        module,
        i32sToStack(names.map(strToStack)),
        names.length,
        strToStack(defaultName),
        condition,
        value,
      ),
    );
  ...
  self["call"] = function (name, operands, type) {
    return preserveStack(() =>
      Module["_BinaryenCall"](
        module,
        strToStack(name),
        i32sToStack(operands),
        operands.length,
        type,
      ),
    );
  ...
  // instead.
  self["callIndirect"] = self["call_indirect"] = function (
    table,
    target,
    operands,
    params,
  ...
  self["returnCallIndirect"] = self["return_call_indirect"] = function (
    table,
    target,
    operands,
    params,
    ...
    return preserveStack(() =>
      Module["_BinaryenReturnCallIndirect"](
        module,
        strToStack(table),
        target,
        i32sToStack(operands),
    ...
    copy(dest, source, size, destMemory, sourceMemory) {
      return preserveStack(() =>
        Module["_BinaryenMemoryCopy"](
          ...
          source,
          size,
          strToStack(destMemory),
          strToStack(sourceMemory),
        ),
      );
    },
  ...
  self["try"] = function (name, body, catchTags, catchBodies, delegateTarget) {
    return preserveStack(() =>
      Module["_BinaryenTry"](
        ...
        catchBodies.length,
        delegateTarget ? strToStack(delegateTarget) : 0,
      ),
    );
  };
  self["throw"] = function (tag, operands) {
    return preserveStack(() =>
      Module["_BinaryenThrow"](
        module,
        strToStack(tag),
        i32sToStack(operands),
        operands.length,
  ...
  self["rethrow"] = function (target) {
    return preserveStack(() =>
      Module["_BinaryenRethrow"](module, strToStack(target)),
    );
  };
  ...
  self["getFunction"] = function (name) {
    return preserveStack(() =>
      Module["_BinaryenGetFunction"](module, strToStack(name)),
    );
  };
  self["removeFunction"] = function (name) {
    return preserveStack(() =>
      Module["_BinaryenRemoveFunction"](module, strToStack(name)),
    );
  };
  self["addGlobal"] = function (name, type, mutable, init) {
    return preserveStack(() =>
      Module["_BinaryenAddGlobal"](
        module,
        strToStack(name),
        type,
        mutable,
  ...
  self["getGlobal"] = function (name) {
    return preserveStack(() =>
      Module["_BinaryenGetGlobal"](module, strToStack(name)),
    );
  };
  self["addTable"] = function (
    ...
    initial,
    maximum,
    type = Module["_BinaryenTypeFuncref"](),
  ) {
    return preserveStack(() =>
      Module["_BinaryenAddTable"](
        module,
        strToStack(table),
        initial,
        maximum,
  ...
  self["getTable"] = function (name) {
    return preserveStack(() =>
      Module["_BinaryenGetTable"](module, strToStack(name)),
    );
  };
  self["addActiveElementSegment"] = function (
    table,
    name,
    funcNames,
    ...
    return preserveStack(() =>
      Module["_BinaryenAddActiveElementSegment"](
        module,
        strToStack(table),
        strToStack(name),
  ...
  self["addPassiveElementSegment"] = function (name, funcNames) {
    return preserveStack(() =>
      Module["_BinaryenAddPassiveElementSegment"](
        module,
        strToStack(name),
        i32sToStack(funcNames.map(strToStack)),
        funcNames.length,
  ...
  self["getElementSegment"] = function (name) {
    return preserveStack(() =>
      Module["_BinaryenGetElementSegment"](module, strToStack(name)),
    );
  };
  self["getTableSegments"] = function (table) {
    ...
    for (var i = 0; i < numElementSegments; i++) {
      ...
      var elemTableName = UTF8ToString(
        Module["_BinaryenElementSegmentGetTable"](segment),
      );
  ...
  self["removeGlobal"] = function (name) {
    return preserveStack(() =>
      Module["_BinaryenRemoveGlobal"](module, strToStack(name)),
    );
  };
  self["removeTable"] = function (name) {
    return preserveStack(() =>
      Module["_BinaryenRemoveTable"](module, strToStack(name)),
    );
  };
  self["removeElementSegment"] = function (name) {
    return preserveStack(() =>
      Module["_BinaryenRemoveElementSegment"](module, strToStack(name)),
    );
  };
  self["addTag"] = function (name, params, results) {
    return preserveStack(() =>
      Module["_BinaryenAddTag"](module, strToStack(name), params, results),
    );
  };
  self["getTag"] = function (name) {
    return preserveStack(() =>
      Module["_BinaryenGetTag"](module, strToStack(name)),
    );
  };
  self["removeTag"] = function (name) {
    return preserveStack(() =>
      Module["_BinaryenRemoveTag"](module, strToStack(name)),
    );
  };
  self["addFunctionImport"] = function (
    internalName,
    externalModuleName,
    externalBaseName,
    params,
    ...
    return preserveStack(() =>
      Module["_BinaryenAddFunctionImport"](
        module,
  ...
  self["addTableImport"] = function (
    internalName,
    externalModuleName,
    externalBaseName,
  ) {
    return preserveStack(() =>
      Module["_BinaryenAddTableImport"](
        module,
        strToStack(internalName),
        strToStack(externalModuleName),
        strToStack(externalBaseName),
  ...
  self["addMemoryImport"] = function (
    ...
    return preserveStack(() =>
      Module["_BinaryenAddMemoryImport"](
        module,
        strToStack(internalName),
        strToStack(externalModuleName),
        strToStack(externalBaseName),
  ...
  self["addGlobalImport"] = function (
    ...
    return preserveStack(() =>
      Module["_BinaryenAddGlobalImport"](
        module,
        strToStack(internalName),
        strToStack(externalModuleName),
        strToStack(externalBaseName),
  ...
  self["addExport"] = // deprecated
    self["addFunctionExport"] = function (internalName, externalName) {
      return preserveStack(() =>
        Module["_BinaryenAddFunctionExport"](
          module,
          strToStack(internalName),
          strToStack(externalName),
        ),
      );
    };
  self["addTableExport"] = function (internalName, externalName) {
    return preserveStack(() =>
      Module["_BinaryenAddTableExport"](
        module,
        strToStack(internalName),
        strToStack(externalName),
      ),
  ...
  self["addMemoryExport"] = function (internalName, externalName) {
    return preserveStack(() =>
      Module["_BinaryenAddMemoryExport"](
        module,
        strToStack(internalName),
        strToStack(externalName),
      ),
  ...
  self["addGlobalExport"] = function (internalName, externalName) {
    return preserveStack(() =>
      Module["_BinaryenAddGlobalExport"](
        module,
        strToStack(internalName),
        strToStack(externalName),
      ),
  ...
  self["removeExport"] = function (externalName) {
    return preserveStack(() =>
      Module["_BinaryenRemoveExport"](module, strToStack(externalName)),
    );
  };
  self["setMemory"] = function (
    initial,
    maximum,
    exportName,
    segments = [],
  ...
  self["getMemorySegmentInfo"] = function (name) {
    return preserveStack(() => {
      const passive = Boolean(
        Module["_BinaryenGetMemorySegmentPassive"](module, strToStack(name)),
      );
      let offset = null;
      if (!passive) {
        offset = Module["_BinaryenGetMemorySegmentByteOffset"](
          module,
          strToStack(name),
        );
      }
      return {
        ...
        data: (function () {
          ...
          Module["_BinaryenCopyMemorySegmentData"](
            module,
            strToStack(name),
            ptr,
          );
  ...
  self["setFieldName"] = function (heapType, index, name) {
    return preserveStack(() =>
      Module["_BinaryenModuleSetFieldName"](
        module,
        heapType,
        index,
        strToStack(name),
  ...
  self["addCustomSection"] = function (name, contents) {
    return preserveStack(() =>
      Module["_BinaryenAddCustomSection"](
        module,
        strToStack(name),
        i8sToStack(contents),
        contents.length,
  ...
  self["getExport"] = function (externalName) {
    return preserveStack(() =>
      Module["_BinaryenGetExport"](module, strToStack(externalName)),
    );
  };
  ...
  self["runPasses"] = function (passes) {
    return preserveStack(() =>
      Module["_BinaryenModuleRunPasses"](
        module,
        i32sToStack(passes.map(strToStack)),
        passes.length,
      ),
    );
  };
  self["runPassesOnFunction"] = function (func, passes) {
    if (typeof func === "string") func = self["getFunction"](func);
    return preserveStack(() =>
      Module["_BinaryenFunctionRunPasses"](
        func,
        module,
        i32sToStack(passes.map(strToStack)),
        passes.length,
  ...
  self["emitBinary"] = function (sourceMapUrl) {
    return preserveStack(() => {
      ...
      Module["_BinaryenModuleAllocateAndWrite"](
        tempBuffer,
        module,
        strToStack(sourceMapUrl),
      );
  ...
  self["addDebugInfoFileName"] = function (filename) {
    return preserveStack(() =>
      Module["_BinaryenModuleAddDebugInfoFileName"](
        module,
        strToStack(filename),
      ),
    );
  ...
  self["getDebugInfoFileName"] = function (index) {
    return UTF8ToString(
      Module["_BinaryenModuleGetDebugInfoFileName"](module, index),
    );
  };
  self["setDebugLocation"] = function (
    func,
    expr,
    fileIndex,
    lineNumber,
    ...
    return Module["_BinaryenFunctionSetDebugLocation"](
      func,
      expr,
      fileIndex,
      lineNumber,
...
Module["TypeBuilder"] = function (size) {
  ...
  this["setSignatureType"] = function (index, paramTypes, resultTypes) {
    Module["_TypeBuilderSetSignatureType"](
      builder,
      index,
      paramTypes,
      resultTypes,
  ...
  this["setStructType"] = function (index, fields = []) {
    ...
    preserveStack(() => {
      ...
      Module["_TypeBuilderSetStructType"](
        builder,
        index,
        i32sToStack(types),
  ...
  this["setArrayType"] = function (
    index,
    elementType,
    elementPackedType,
    elementMutable,
  ) {
    Module["_TypeBuilderSetArrayType"](
      builder,
      index,
      elementType,
      elementPackedType,
  ...
  this["getTempTupleType"] = function (types) {
    return preserveStack(() => {
      return Module["_TypeBuilderGetTempTupleType"](
        builder,
        i32sToStack(types),
        types.length,
      );
...
Module["Relooper"] = function (module) {
  assert(
    module &&
      ...
      module["block"] &&
      module["if"],
  ); // guard against incorrect old API usage
  ...
  this["addBranchForSwitch"] = function (from, to, indexes, code) {
    return preserveStack(() =>
      Module["_RelooperAddBranchForSwitch"](
        from,
        to,
        i32sToStack(indexes),
        indexes.length,
...
/** @constructor */
Module["ExpressionRunner"] = function (
  module,
  flags,
  maxDepth,
  maxLoopIterations,
) {
  const runner = Module["_ExpressionRunnerCreate"](
    module["ptr"],
    flags,
    maxDepth,
    maxLoopIterations,
  ...
  this["setLocalValue"] = function (index, valueExpr) {
    return Boolean(
      Module["_ExpressionRunnerSetLocalValue"](runner, index, valueExpr),
    );
  };
  this["setGlobalValue"] = function (name, valueExpr) {
    return preserveStack(() =>
      Boolean(
        Module["_ExpressionRunnerSetGlobalValue"](
          runner,
          strToStack(name),
          valueExpr,
        ),
...
Module["getExpressionInfo"] = function (expr) {
  ...
  switch (id) {
    case Module["ConstId"]:
      switch (type) {
        case Module["i32"]:
          info.value = Module["_BinaryenConstGetValueI32"](expr);
          break;
        case Module["i64"]:
          info.value = {
          ...
          break;
        case Module["f32"]:
          info.value = Module["_BinaryenConstGetValueF32"](expr);
          break;
        case Module["f64"]:
          info.value = Module["_BinaryenConstGetValueF64"](expr);
          break;
        case Module["v128"]: {
          preserveStack(() => {
    ...
    default: {
      ...
      Object.keys(staticMembers).forEach((memberName) => {
        ...
        if (typeof member === "function") {
          ...
          if (
            member.length === 1 &&
            (match = memberName.match(/(^get|^(?=is|has))/))
          ) {
            const index = match[1].length;
            const propertyName =
              memberName.charAt(index).toLowerCase() +
...
Module["createType"] = function (types) {
  return preserveStack(() =>
    Module["_BinaryenTypeCreate"](i32sToStack(types), types.length),
  );
};
...
Module["addPassToSkip"] = function (pass) {
  preserveStack(() => {
    Module["_BinaryenAddPassToSkip"](strToStack(pass));
  });
};
...
function makeExpressionWrapper(expressionId, ownStaticMembers) {
  ...
  (SpecificExpression.prototype = Object.create(
    Expression.prototype,
  )).constructor = SpecificExpression;
...
Module["Block"] = makeExpressionWrapper(Module["_BinaryenBlockId"](), {
  ...
  setChildren(expr, children) {
    setAllNested(
      ...
      children,
      Module["_BinaryenBlockGetNumChildren"],
      Module["_BinaryenBlockSetChildAt"],
      Module["_BinaryenBlockAppendChild"],
  ...
  setNames(expr, names) {
    preserveStack(() => {
      setAllNested(
        ...
        Module["_BinaryenSwitchGetNumNames"],
        Module["_BinaryenSwitchSetNameAt"],
        Module["_BinaryenSwitchAppendName"],
        Module["_BinaryenSwitchRemoveNameAt"],
      );
    });
  },
  getDefaultName(expr) {
...
Module["Call"] = makeExpressionWrapper(Module["_BinaryenCallId"](), {
  ...
  setOperands(expr, operands) {
    setAllNested(
      ...
      operands,
      Module["_BinaryenCallGetNumOperands"],
      Module["_BinaryenCallSetOperandAt"],
      Module["_BinaryenCallAppendOperand"],
  ...
  Module["_BinaryenCallIndirectId"](),
  {
    ...
    setOperands(expr, operands) {
      setAllNested(
        ...
        operands,
        Module["_BinaryenCallIndirectGetNumOperands"],
        Module["_BinaryenCallIndirectSetOperandAt"],
...
Module["Try"] = makeExpressionWrapper(Module["_BinaryenTryId"](), {
  ...
  setCatchTags(expr, catchTags) {
    preserveStack(() => {
      setAllNested(
        ...
        Module["_BinaryenTryGetNumCatchTags"],
        Module["_BinaryenTrySetCatchTagAt"],
        Module["_BinaryenTryAppendCatchTag"],
        Module["_BinaryenTryRemoveCatchTagAt"],
      );
    });
  },
  ...
  setCatchBodies(expr, catchBodies) {
    setAllNested(
      ...
      catchBodies,
      Module["_BinaryenTryGetNumCatchBodies"],
      Module["_BinaryenTrySetCatchBodyAt"],
      Module["_BinaryenTryAppendCatchBody"],
...
Module["Throw"] = makeExpressionWrapper(Module["_BinaryenThrowId"](), {
  ...
  setOperands(expr, operands) {
    setAllNested(
      ...
      operands,
      Module["_BinaryenThrowGetNumOperands"],
      Module["_BinaryenThrowSetOperandAt"],
      Module["_BinaryenThrowAppendOperand"],
...
Module["TupleMake"] = makeExpressionWrapper(Module["_BinaryenTupleMakeId"](), {
  ...
  setOperands(expr, operands) {
    setAllNested(
      ...
      operands,
      Module["_BinaryenTupleMakeGetNumOperands"],
      Module["_BinaryenTupleMakeSetOperandAt"],
      Module["_BinaryenTupleMakeAppendOperand"],
